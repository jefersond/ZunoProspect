    ...
    <section id="referral-section" className="bg-background py-16 md:py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto mb-10 grid max-w-5xl gap-5 md:grid-cols-3">
          <Card className="rounded-lg border-border/50 bg-zinc-950/50 p-6 text-center">
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-lg border border-blue-500/20 bg-blue-500/10 text-blue-400">
          ...
          <Card className="rounded-lg border-border/50 bg-zinc-950/50 p-6 text-center">
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-lg border border-purple-500/20 bg-purple-500/10 text-purple-400">
          ...
          <Card className="rounded-lg border-border/50 bg-zinc-950/50 p-6 text-center">
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-lg border border-emerald-500/20 bg-emerald-500/10 text-emerald-400">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-8 inline-flex items-start gap-2 rounded-lg border border-amber-500/25 bg-amber-500/10 px-4 py-3 text-left text-sm text-amber-100">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            {user ? (
              <Button size="lg" className="h-14 w-full bg-emerald-500 px-8 text-base font-medium text-white hover:bg-emerald-600 sm:w-auto" onClick={handleCopyLink}>
                <Copy className="mr-2 h-5 w-5" />
                Copiar meu link
              </Button>
            ) : (
              <Button size="lg" className="h-14 w-full bg-emerald-500 px-8 text-base font-medium text-white hover:bg-emerald-600 sm:w-auto" onClick={handleSignup}>
                Criar conta grátis
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            )}
            <div className="inline-flex items-center gap-2 rounded-lg border border-emerald-500/20 bg-emerald-500/10 px-4 py-3 text-sm font-medium text-emerald-300">
