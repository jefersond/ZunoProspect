...
export function PipelineColumn({ status, leads, onViewDetails }: PipelineColumnProps) {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`flex flex-col min-w-[280px] w-[280px] bg-muted/30 rounded-lg border transition-colors ${
        isOver 
    ...
    >
      {/* Column Header */}
      <div className={`p-3 border-b ${status.borderColor} bg-gradient-to-r from-transparent ${status.bgColor}`}>
