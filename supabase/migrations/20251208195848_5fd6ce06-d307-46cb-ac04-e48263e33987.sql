-- Create RPC function to get a specific lead decrypted by ID (for backend use)
-- This function uses SECURITY DEFINER and accepts lead_id directly
-- Used by edge functions that run with service role
