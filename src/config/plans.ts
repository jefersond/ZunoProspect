...
export const PLANS: Record<PlanId, PlanConfig> = {
  starter: {
    ...
    subtitle: "Para começar com prospecção consistente",
    monthlyPrice: 47,
    annualPrice: 470,
    leadsLimit: 300,
    aiLimit: 30,
  ...
  pro: {
    ...
    name: "Pro",
    displayName: "Pro",
    subtitle: "Para profissionais que precisam vender mais",
    monthlyPrice: 97,
    annualPrice: 970,
    leadsLimit: 800,
    aiLimit: 100,
    ...
    features: [
      "Tudo do Iniciante",
      "Análise completa e score de conversão",
  ...
  agency: {
    ...
    name: "Agency",
    displayName: "Agência",
    subtitle: "Para agências e times comerciais",
    monthlyPrice: 247,
    annualPrice: 2470,
    leadsLimit: 2000,
    aiLimit: 300,
