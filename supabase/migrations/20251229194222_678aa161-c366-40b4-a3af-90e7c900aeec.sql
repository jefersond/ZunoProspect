-- Add USA prospecting add-on columns to user_subscriptions
ALTER TABLE public.user_subscriptions 
ADD COLUMN IF NOT EXISTS usa_addon BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS usa_addon_active_until TIMESTAMPTZ DEFAULT NULL;

-- Add country column to leads
...
-- Update the insert_lead_with_encryption_v2 function to accept pais parameter
